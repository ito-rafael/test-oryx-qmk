...
* Dispatch
#+name: layout-options
#+begin_src python :var layout_id="zWNBJ" keyboard_type="moonlander" :results output
print('on:')
...
print('          git merge -Xignore-all-space --allow-unrelated-histories ' + branch_name)
print('          git push')
#+end_src
...
print('          mkdir -p ${keyboard_directory}/${{ github.event.inputs.layout_geometry }}/keymaps && cp -r ' + directory + ' "$_"')
print('          ')
...
<<layout-options(layout_id="zWNBJ", keyboard_type="moonlander")>>
<<jobs>>
...
<<merge(branch_name="moonlander-oryx")>>
...
#+end_src
** Planck EZ
#+begin_src conf :noweb yes :tangle test_planck.yml :results output
<<workflow-name(name="Planck EZ")>>
<<layout-options(layout_id="zWNBJ", keyboard_type="planck_ez/glow")>>
<<jobs>>
<<checkout(branch_name="planck-oryx")>>
<<pull>>
<<download-oryx>>
